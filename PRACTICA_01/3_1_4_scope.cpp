...
interno anidado. Si se accede al nombre dentro del bloqueexterior, pero después del bloque interno, ¿qué declaración se utiliza?*/
...
int main(){
    ...
    cout<<arg1<<"\n";//SE UTILIZA LA DECLARACION DEL BLOQUE EXTERNO
	return 0;
}
